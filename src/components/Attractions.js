...
const Attractions = ({ match }) => (
	<div classNameName='main-content attraction'>
		<div classNameName='attraction-header group'>
			<h2>Attractions</h2>
			<ul classNameName='attraction-nav'>
				<li>
					<NavLink to={`${match.url}/newyork`}>NEW-YORK</NavLink>
				</li>
				<li>
					<NavLink to={`${match.url}/losangeles`}>LA</NavLink>
				</li>
				<li>
					<NavLink to={`${match.url}/dallas`}>DALLAS</NavLink>
				</li>
				<li>
					<NavLink to={`${match.url}/vegas`}>VEGAS</NavLink>
				</li>
			</ul>
		</div>
		...
		<Route
			exact
			path={match.path}
			render={() => <Redirect to={`${match.path}/newyork`} />}
		/>
